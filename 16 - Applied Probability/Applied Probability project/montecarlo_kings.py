...
# Questo è solo un esempio visivo di come potrebbe apparire un frame di codice
# Non è necessario eseguirlo, serve solo come riferimento visivo.
# Per il tuo video, userai direttamente uno screenshot del codice Python.
# 
# print("\n--- Esempio di Codice Python (per screenshot del video) ---")
# print("""
# import random
# 
# def check_adjacent_kings():
#     deck = ['K', 'K', 'K', 'K'] + ['Other'] * 48
#     random.shuffle(deck)
...
#     if check_adjacent_kings():
#         hits += 1
# 
# print(f"Probabilità stimata: {hits / num_sims:.4f}")
# """)